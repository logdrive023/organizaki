...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  return {
    title: `${event.title} - Organizaki`,
    description: `Detalhes do evento ${event.title}. Data: ${event.date}, Local: ${event.location}. Confirme sua presença e veja a lista de presentes.`,
    openGraph: {
      title: `${event.title} - Organizaki`,
      description: `Detalhes do evento ${event.title}. Data: ${event.date}, Local: ${event.location}. Confirme sua presença e veja a lista de presentes.`,
      url: `https://organizaki.com.br/evento/${params.id}`,
      siteName: "Organizaki",
      images: [
        {
          url: event.coverImage || "/og-event-image.jpg",
          width: 1200,
          height: 630,
          alt: event.title,
        },
...
export default function PublicEventPage({ params }) {
  ...
  return (
    <>
      {/* JSON-LD para Rich Snippets do evento */}
      <Script
        id="schema-event"
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            image: [event.coverImage || "/og-event-image.jpg"],
      ...
      <div className="min-h-screen bg-gradient-to-b from-primary/5 via-background to-background">
        ...
        <div className="relative h-[350px] w-full overflow-hidden md:h-[450px]">
          <Image
            ...
            alt={`Imagem de capa do evento ${event.title}`}
            fill
        ...
        <div className="container mb-6">
          <AdBanner slot="6789012345" format="horizontal" className="mx-auto max-w-5xl" />
        </div>
        ...
        <div className="container pb-16">
          <Tabs defaultValue="info" className="w-full">
            ...
            <TabsContent value="info" className="space-y-6 py-6">
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-3">
                      <Avatar className="h-10 w-10 border-2 border-primary/20">
                        <AvatarImage src="/woman-portrait.png" alt="Maria Silva - Anfitriã do evento" />
                    ...
                    <div className="flex items-center gap-3">
                      <Avatar className="h-10 w-10 border-2 border-primary/20">
                        <AvatarImage src="/thoughtful-man-portrait.png" alt="João Santos - Anfitrião do evento" />
              ...
              {/* Anúncio no meio da aba de informações */}
              <div className="py-2">
                <AdBanner slot="7890123456" format="rectangle" className="mx-auto max-w-5xl" />
              </div>
              ...
              <div className="rounded-lg border bg-card p-6 shadow-sm">
                ...
                <div className="aspect-video overflow-hidden rounded-md bg-muted">
                  <iframe
                    ...
                    title={`Localização do evento ${event.title}`}
                  ></iframe>
                </div>
            ...
            <TabsContent value="gifts" className="py-6">
              <div className="mb-6 rounded-lg border bg-card p-6 shadow-sm">
                ...
                <p className="text-muted-foreground">
                  Escolha um presente da lista abaixo para presentear os noivos. Você pode filtrar por categoria ou
                  faixa de preço.
                </p>
              </div>
              ...
              <div className="mb-6">
                <AdBanner slot="8901234567" format="horizontal" className="mx-auto max-w-5xl" />
              </div>
            ...
            <TabsContent value="confirm" className="py-6">
              ...
              <div className="mb-6">
                <AdBanner slot="9012345678" format="horizontal" className="mx-auto max-w-5xl" />
              </div>
        ...
        <div className="border-t bg-muted/30">
          <div className="container py-6">
            <div className="flex flex-col items-center justify-center gap-4 text-center">
              <p className="text-sm text-muted-foreground">Evento gerenciado com Organizaki.</p>
              <div className="flex gap-2">
