                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="italic text-muted-foreground">
                        "Organizei meu casamento em menos de uma semana! A plataforma é super intuitiva e os convidados
                        adoraram a facilidade para confirmar presença."
                      </p>
              ...
              <Accordion type="single" collapsible className="w-full">
                ...
                >
                  ...
                  <AccordionContent className="pb-4 text-muted-foreground">
                    O Organizaki oferece um plano gratuito que permite criar um evento com até 50 convidados e 20 itens
                    na lista de presentes. Para eventos maiores, oferecemos planos pagos a partir de R$ 29,90 por
                    evento, com recursos adicionais como personalização avançada, domínio personalizado e suporte
                    prioritário.
                  </AccordionContent>
                </AccordionItem>
                ...
                >
                  ...
                  <AccordionContent className="pb-4 text-muted-foreground">
                    Você pode adicionar presentes manualmente com nome, descrição, preço e link para compra, ou importar
                    produtos diretamente de lojas parceiras. Os convidados podem reservar presentes, sendo
                ...
                >
                  ...
                  <AccordionContent className="pb-4 text-muted-foreground">
                    Sim! Você pode personalizar cores, fontes, imagens de fundo e outros elementos visuais da página do
                    seu evento. Nos planos pagos, você tem acesso a temas exclusivos e opções avançadas de
                ...
                >
                  ...
                  <AccordionContent className="pb-4 text-muted-foreground">
                    ...
                    exportadas incluem todas as informações relevantes, como status de confirmação, mensagens e detalhes
                    de contato.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
